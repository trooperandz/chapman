...
$query = "SELECT monthly_ros, days_week, total_bays, true_L1bays, true_L2bays
		  FROM express_effect_test WHERE dealerID = $dealerID AND surveyindex_id = $surveyindex_id";
...
$query = "SELECT maxvol_L1bay, maxvol_L2bay, maxvol_htrbay FROM bay_volume_test";		  
$result = $mysqli->query($query);
if(!$result) { 
...
<div class="row">
	<div class="small-12 medium-10 large-10 columns">
		<h2 class="small-only-text-center"> Express Volume Analysis</h2>
	</div>
	<div class="small-12 medium-2 large-2 columns">
