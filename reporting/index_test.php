...
$dealerObj = new DealerInfo($dbo = null);
?>
...
<head>
    ...
    <!-- Custom styles for Edumix template -->
...
<body>
    ...
    <div class="off-canvas-wrap" data-offcanvas>
        <div class="inner-wrap">  <!-- right sidebar wrapper -->

        <?php
            // Include the sidebar menu.  User types dictate visibility of menu options, which dictates ability to access various pages
                ...
                <div class="top-bar-nest">
                    <nav class="top-bar" data-topbar role="navigation" data-options="is_hover: false">
                        ...
                        <section class="top-bar-section ">
                            ...
                            <?php
                            // Show the dealer select dropdown if user is SOS or Manuf type
                            if($_SESSION['user']['user_type_id'] == 1) {
                                echo'
                                <li class="has-form bg-white">
                                        <select class="dlr-select" style="width: 150px; height: 38px; margin-top: 3px;">
                                            <option value="">Select Dealer ...</option>';
                                    // Get active dealers
                                    $dealers = $dealerObj->getDealerInfo();
                                    foreach($dealers as $dealer) {
                                        echo '<option value="'.$dealer['dealerID'].'#'.$dealer['dealername'].'#'.$dealer['dealercode'].'">'.$dealer['dealername'].' ('.$dealer['dealercode'].')</option>';
                                    }
                                        echo'
                                        </select>
                                </li>';
