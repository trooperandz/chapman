...
if (!defined('LIVE')) {
	...
	define ('BASE_URI', '/var/www/chapmantracking.com/public_html/reporting/'); // Set this to your web directory
	define ('BASE_URL', 'www.chapmantracking.com/reporting/');
  // Use this for providing user with main login form link in reset password confirmation email (after pass has already been reset)
	define ('INDEX_FULL', 'www.chapmantracking.com/reporting/index.php');
	define ('INDEX_SHORT', 'index.php');
	define ('MANUF', 'Chapman');
	...
	define ('USER_DOC_DIR', '/var/www/chapmantracking.com/public_html/reporting/system/user_docs/');
