  ...
  //     );
      ...
      $paramsArr = array(
		...
		if ($_POST['action'] == 'add_dealers') {
			...
			echo $DealerInfo->processAddNewDealers(array('edit_dealer_val'=>$_POST['edit_dealer_val'], 'edit_dealer_id'=>$_POST['edit_dealer_id']));
      ...
      $paramsArr = array(
        ...
        'link_msg'=>'Add Row'
			...
			echo $Admin->getPageHeading($pageArr).$Admin->getUserRequestTable($paramsArr);
		}

		if ($_POST['action'] == 'add_user_req_row') {
			// Make sure to make the result js-compatible
			echo $Admin->addUserRequestRow();
		}
      ...
      $paramsArr = array(
		...
		if($_POST['action'] == 'add_new_user_row') {
			...
			echo $Admin->getAddUserTable($paramsArr);
		}
      ...
      $userParamsArr = array(
        ...
        'edit_user_id'=>$_POST['edit_user_id']
            ...
            'success_msg'=>'*User '.$user_name_success.' has been updated successfully!'
					...
					echo $Admin->getPageHeading($array).$Admin->getSuccessMsg($pageArr);
            ...
            'success_msg'=>'*The users you submitted have been processed successfully.  An email confirmation has been sent to: '.$_SESSION['user']['user_email']
					...
					echo $Admin->getPageHeading($pageArr)
		...
		if($_POST['action'] == 'get_dealer_info_js') {
			// Make sure to make the result js-compatible
      echo json_encode($DealerInfo->getDealerListing());
		}
     ...
     * User type reference:  1 == SOS, 2 == Manuf, 3 == Dealer
      ...
      $pageArr = array(
        ...
        'user_count'=>true
			...
			echo $Admin->getPageHeading($pageArr).$user_table;
		}
      ...
      $userTable = $Admin->getUserTable($tableArr);
			...
			echo $Admin->getPageHeading($pageArr).$userTable;
		}
      ...
      $paramsArr = array(
        ...
        'dealer_id'=>$_POST['dealer_id']
			...
			echo $DealerInfo->getPageHeading($pageArr).$DealerInfo->getAddDealerTable($paramsArr);
		}
      ...
      $pageArr = array(
        ...
        'link_msg'=>null
			...
			echo $Documents->getPageHeading($pageArr).$Documents->getFileUploadForm();
		}
      ...
      $pageArr = array(
        ...
        'link_msg'=>'View System Documents'
			...
			echo $Documents->getPageHeading($pageArr)
      ...
      $pageArr = array(
        ...
        'link_msg'=>'Add New Document'
			...
			echo $Documents->getPageHeading($pageArr).$documentTable;
		}
      ...
      $pageArr = array(
        ...
        'link_msg'=>'Add New Document'
			...
			echo $Documents->getPageHeading($pageArr).$table;
		}
      ...
      $pageArr = array(
        ...
        'link_msg'=>'View System Docs'
			...
			echo $Documents->getPageHeading($pageArr).$Documents->getFileUploadForm(array('edit_doc_id'=>$_POST['edit_doc_id']));
		}
      ...
      $pageArr = array(
        ...
        'title_info'=>'Comments? Suggestions?'
			...
			echo $ContactUs->getPageHeading($pageArr).$ContactUs->getContactForm();
		}
      ...
      $pageArr = array(
        ...
        'title_info'=>'Comments? Suggestions?'
			...
			echo $ContactUs->getPageHeading($pageArr)
