...
Class Modal extends DB_Connect {
	...
	public function getRoSearchModal($title) {
	    ...
	    <div id="ro_search_modal" class="reveal-modal" style="background: #f5f5f5;" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
		 	...
		 	if($this->user_sos || ($this->user_dlr && $this->user_admin) || $this->user_manuf) {
   ...
   public function getMetricsSearchModal($title) {
   		// Provide all methods with access to DealerInfo and UserInfo classes:
   		$obj = new DealerInfo($dbo=null);
   		$advisors = new UserInfo($dbo=null);
   	...
   	public function getStatsSearchModal($title) {
   		// Provide all items access to DealerInfo and UserInfo classes
   		$obj = new DealerInfo($dbo=null);
   		$advisors = new UserInfo($dbo=null);
   ...
   public function getUserProfileModal() {
    ...
    public function getAlertModal() {
        $html =
        '<div id="alert-modal" class="reveal-modal small" style="background: #f5f5f5;" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
            <h2 class="blue" id="modalTitle">SOS Online Reporting</h2>
            <fieldset>
