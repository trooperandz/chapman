...
Class DealerInfo extends PDO_Connect {	
	...
	/**
	 * Build the main page heading. Note: $array contains 'page_title', 'title_info', 'a_id', 'export_icon', 'print-icon', 'dealer_count'
	 * @param {array} $array Array of heading specification information which determines items to include in the heading
