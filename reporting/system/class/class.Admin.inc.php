...
Class Admin extends PDO_Connect  {
    ...
    /**
     * Build the main page heading. Note: $array contains: 'page_title', 'a_id', 'link_msg'
     * @param {array} $array Array of specification strings which determine the main heading items
     * @return {string} $html The html structure for the main heading
     */
		...
		<div class="title_area">
           	<div class="row">
           		<div class="small-12 medium-9 large-9 columns">
                    ...
                    // Only show the 'Add New User' link to SOS admin and Dealer admin users
                    if(($this->user_sos && $this->user_admin) || ($this->user_dlr && $this->user_admin)) {
           				if($array['a_id']) {
           					$html .='
           					<a class="'.$array['a_id'].'" id="'.$array['a_id'].'" data-text-original="Select All" data-text-swap="Unselect All" style="color: green; font-size: 15px;"> &nbsp; '.$msg.' </a>';
           				}
                    }
    ...
    public function getSidebarMenu() {
        ...
        //     -Metrics Trending: (Only SOS admin, SOS non-admin, Dealer admin)
        //       Note: Individual search input components require unique access:
        //          *Date Range: All users
        //          *Advisor: SOS users, Dealer admin users, manuf users
        ...
        //      Note: Doc category dropdown available <option>'s are determined in Documents class (completed)
                    ...
                    <div class="side-bar">
                        ...
                        if(!$this->user_dlr) {
                            ...
                            <li>
                                ...
                                // Only show Dealer Trending to SOS admin, SOS non-admin, Dealer admin users
                        ...
                        // Show the Manage Users link to all users except for Manuf users & Dealer non-admin users
                        if($this->user_sos || ($this->user_dlr && $this->user_admin)) {
                            $html .='
                            <li>
       		                                ...
       		                                if ($array['forgot_pass_link']) {
       		                                  ...
       		                                  $html .='
       		                                  	...
       		                                  	<div class="row collapse">
       		                                        ...
       		                                        <div class="small-10 columns">
       		                                            <input type="password" id="pass1" name="pass1" placeholder="Enter new password">
       		                                        </div>
       		                                    </div>
       		                                    <div class="row collapse">
       		                                        <div class="small-2 columns">
       		                                        ...
       		                                        <div class="small-10 columns">
       		                                            <input type="password" id="pass2" name="pass2" placeholder="Verify password">
       		                                        </div>
       		                                    </div>
       		                                    <input type="submit" class="tiny button radius" id="'.$submit_id.'" name="'.$submit_id.'" value="'.$submit_val.'" />';
       		                                } elseif ($array['get_login_form']) {
