<?php
/* ----------------------------------------------------------------------------------------*
   Program: init_global_vars.php

   Purpose: Used as standard include for global reports => sets dealer & survey type magic 
			variables
	...
	11/26/2014	Changed $globalsurveyindex_id to $surveyindex_id to 
				comply with query includes in global reports				Matt Holland
	02/27/2015	Added setting of $dealerID and $dealercode vars				Matt Holland
 *------------------------------------------------------------------------------------------*/

// Set initial dealerID and dealercode variables from SESSION variables
if (isset($_SESSION['dealerID'])) {
	$dealerID = $_SESSION['dealerID'];  // Dealer ID set at login
}
if (isset($_SESSION['dealercode'])) {
	$dealerID = $_SESSION['dealercode'];  // Dealer code set at login
}
