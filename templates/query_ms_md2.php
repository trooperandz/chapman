...
FROM mileagespread LEFT JOIN repairorder ON (mileagespread.mileagespreadID = repairorder.mileagespreadID AND dealerID IN($dealerIDs2) AND surveyindex_id IN ($surveyindex_id))
