...
if ($comparisonsurvey_test == FALSE) {
	...
	$_SESSION['comparisonsurveyindex_id'] 	  = $surveyindex_id;
	$_SESSION['comparisonsurvey_description'] = $comparisonsurvey_description;
	$_SESSION['comparisonsurveyindexid_rows'] = 1;  // Inside of this if statement, there can only be 1 row for the fetch_assoc()
