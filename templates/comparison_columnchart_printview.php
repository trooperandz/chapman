<!----------------------------------------------------------------------------*
   Program: comparison_columnchart_printview.php

   Purpose: Provide include template for comparison print report column charts
   History:
    Date		Description						by
	11/16/2014	Initial design and coding		Matt Holland
	11/17/2014	Added $chartcolor2				Matt Holland
*----------------------------------------------------------------------------->
