...
/*------------------------------------------------------------------------------------------------------------*
   ...
   Purpose: Compile all global print reports into one printable webpage
   History:
    Date			Description																by
	12/05/2014		Initial design and coding												Matt Holland
	...
	03/12/2015		Altered Longhorn chart - larger font and new google array format		Matt Holland
/*------------------------------------------------------------------------------------------------------------*/
...
include ('templates/chart_specs_ym_g_p.php');
...
// Include report body
include ('templates/globalbody_printall.php');
...
// Set chart specifications
include ('templates/chart_specs_ym_g_si_p.php');
...
$chart_areaheight = '70%'									;   // Set chart area
...
$chart_fontsize	  = '20'									;	// Set chart font size
$chart_barwidth	  = '75%'									;	// Set chart bar width
...
// Set chart specifications
include ('templates/chart_specs_lofd_g_p.php');
...
// Set chart specifications
include ('templates/chart_specs_lofb_g_p.php');
