...
/* ----------------------------------------------------------------------*
   Program: singleissuecategoryprintview.php

   Purpose: Printer-friendly format of SI Category report
   History:
    Date		Description									by
	08/06/2014	Convert to mysqli							Matt Holland
	08/27/2014	Revamp format with external stylesheet		Matt Holland
