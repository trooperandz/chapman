...
<html>
    <head>
        ...
        <meta name="description" content="Expand, contract, animate forms with jQuery without leaving the page" />
		...
		<div class="wrapper">
			...
			<div class="content">
				<div id="form_wrapper" class="form_wrapper">
					...
					<form class="login active" id="authenticated" method="POST" action="dealer-process.php">
						<h3>Login</h3>
						<div>
							<label><?php print "Welcome {$user->firstName}, you have logged in successfully. <br />\n"; ?>
							<label>Please enter a dealer code:</label>
							<input type="text" name="dealercode" id="dealercode" autofocus />	
							<span class="error">This is an error</span>
						</div>
						<div class="bottom">
							<div class="remember"><a href="loginform.php">Or Logout</a></div>
