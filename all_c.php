...
/* ------------------------------------------------------------------------------------------------*
   Program: viewallcomparisonqueryandchart.php

   Purpose: Compile all comparison reports into one webpage
   History:
    Date		Description																by
	08/10/2014	Initial design and coding												Matt Holland
	09/25/2014	Rewrote to include regionals, new titles & Linux compatibility (isset) 	Matt Holland
	12/02/2014	Rewrote to include standard query and body includes						Matt Holland
...
$chart_height	  = '600'									;	// Set chart height within specified area
$chart_areaheight = '81%'									;   // Set chart area
$chart_areawidth  = '90%'									;   // Set chart area width
$chart_top		  = '35'									;	// Set chart distance from chart area top
...
// Build top panel and error reporting space
echo'
<div class="row">
...
include('templates/comparisonbody_viewall.php')		;
...
$chart_numformat  = '#\'%\''								;   // Set number format
$chart_minvalue   = '0'										;   // Set chart minimum value
$exportanchor  	  = 'ym_c_si_x.php'							;	// Set export anchor reference
$printeranchor 	  = 'ym_c_si_p.php'							; 	// Set printer friendly anchor reference
...
$chart_areaheight= '79%'									;   // Set chart area
$chart_areawidth = '90%'									;   // Set chart area width
...
$chart_numformat  = '#\'%\''								;   // Set number format
$chart_minvalue   = '0'										;   // Set chart minimum value
$exportanchor  	 = 'st_c_x.php'								;	// Set export anchor reference
$printeranchor 	 = 'st_c_p.php'								; 	// Set printer friendly anchor reference
