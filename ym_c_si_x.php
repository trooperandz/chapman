...
/*------------------------------------------------------------------------------------------------------------*
   Program: ym_c_si_x.php

   Purpose: Produce comparison Single Issue Model Year export
...
$filename1		  = 'SIModelYearDistributionComparison.csv'	;	// Set file name for header instruction	
